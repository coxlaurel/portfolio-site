    ...
    <div className='nav-content-container'>
      ...
      <div className='content-container'>
        ...
        <section ref={projectsRef} id="projects">
          <ProjectCard heading="VEND" cardType={["project", "/vend_thumbnail.png"]} caption="Table top vending machine with touchscreen interface to vend all your favorite snacks. Developed interface and firmware integration while working in a cross-disciplinary team." tags={["Python", "Arduino", "Motor circuits", "RasPI"]} />
          <ProjectCard heading="Inkstory" cardType={["project", "/inkstory_thumbnail.jpg"]} caption="Worked with 10+ tattoo artists to deeply understand their values and pain points, then co-designed a mockup tattoo museum solution." tags={["Co-design", "User Research", "Stories"]}/>
          <ProjectCard heading="Cloudy With A Chance Of Pizza" cardType={["project", "/CWACOP_thumbnail.png"]} caption="Dropper-arcade-style pizza-themed video game. Fulfill orders and skillfully catch toppings with pixel-perfect accuracy." tags={["Python", "Pygame Lib", "Game Dev"]} />
          <ProjectCard heading="Spot It! Discrete Math Version" cardType={["project", "/spot_it_thumbnail.png"]} caption="Custom 73-card Spot-It! deck with my discrete mathematics classmates’ faces using balanced incomplete block design theory and automated card generation." tags={["Python", "Pillow Lib", "BIBD"]} />
        </section>
        <section>
          <Footer />
          </section>
